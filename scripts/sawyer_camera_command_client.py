...
if __name__ == '__main__':
    ...
    parser.add_argument('-camera', '-c', type=str, default='right_hand', help=
        'Options: right_hand, head.  Default: right_hand'
    )
    args = parser.parse_args()

    rospy.init_node('camera_command_client')
    camera_command_client(camera='%s_camera' % args.camera, status=True)